// File Name : Auction details 

import React from 'react'
import Wrapper from "../../components/Layout/wrapper"
import AuctionData from "../api/auctionsData.json"
import AuctionSingle from '../../components/widgets/AuctionDeals/AuctionSingle';
import {SectionTitle} from '../../components/Elements/SectionTitle';
import { Themebutton, ThemeLineButton, ThemeLineButton2 } from '../../components/Elements/Button';  //  from components\Elements\Button\index.js
...
const AuctionDetails = () => {
  return (
    ...
    <section className='auction_details lg:pb-0 md:pb-80px lg:pt-155px pt-80px'>
      <div className='container'>
        <div className='details_title mb-6 lg:mb-[57px]'>
          <SectionTitleTwo  title="Cyborg_Robo-6 #23" ></SectionTitleTwo>
          <div className='details_title_bottom flex gap-[10px] items-center'>
        ...
        <div className='auction_details_content grid lg:grid-cols-12 lg:gap-[50px] gap-5'>
          <div className='auction_details_content_img max-w-[648px] lg:col-span-6 col-span-12'>
            <img src="/assets/imgs/auctionsDeals/auction_details_img.png" className='max-w-full rounded-[30px]' alt="" />
          </div>
            ...
            <div className='max-w-[511px]'>
              <div className='auction_details_content_info d-flex mb-6'>
                <div className='flex gap-2 items-center' >
                  ...
                  <h5 className='text-base text-white font-medium'><span className='text-primary'>Cyborg_denim</span> Collections</h5>
                </div>
                <p className='text-base text-white font-medium mt-[10px] mb-4'>Owner <span className='text-primary'>denim369</span> </p>
                <div className='auction_tags flex items-center gap-3 flex-wrap ' >
                  {/* auction_tag_box  */}
              ...
              {/* pricing_box  */}
              <div className='pricing_box border border-primary/30 rounded-2xl p-5 flex mb-6 items-center flex-wrap gap-2'>
                <div className='counter_text flex-1'>
                  <h5 className='text-base text-white font-medium capitalize mb-2'>Auction Ends in</h5>
                  <h3 className='lg:text-40px text-2xl text-primary font-semibold whitespace-nowrap '>21 : 25 : 44</h3>
                </div>
                <Themebutton buttonProps={{link :"#"}}>
                  Make Offer
                </Themebutton>
              </div>
              {/* pricing_box  */}
    ...
    {/* AUCTION_DETAILS::END    */}
      ...
      {/* RECOMMENDED_AREA::start  */}
      <section className="reomanded_area lg:pb-160px md:pb-80px pb-60px lg:pt-155px pt-60px">
        <div className='container'>
          <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
              <SectionTitle>
                Recommended for You
              </SectionTitle>
              <ThemeLineButton buttonProps={{text: "View All", block: "block", button_size: "40" , shadow:"active" , url:"/auction" }} />
          </div>
